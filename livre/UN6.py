...
def List():
    st.success("Clínicas da Família no Rio de Janeiro - Você pode obter mais informações clicando em 'Pesquisar'.")
    ...
    if st.button('Imprimir lista'):
        ...
        save_path = os.path.join(temp_dir, "Relatorio_Clin_Fam.pdf")
