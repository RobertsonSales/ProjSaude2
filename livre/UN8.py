...
def List():
    st.success("Centros de Referência no Rio de Janeiro - Você pode obter mais informações clicando em 'Ir à página'.")
    if st.button('Imprimir lista'):
        ...
        save_path = os.path.join(temp_dir, "Relatorio_C_Ref.pdf")
