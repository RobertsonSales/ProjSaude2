...
def List():
    st.success("Hospitais Estaduais no Rio de Janeiro - Você pode obter mais informações clicando em 'Pesquisar'.")
    ...
    if st.button('Imprimir lista'):
        ...
        save_path = os.path.join(temp_dir, "Relatorio_Hosp_Est.pdf")
        ...
        with open(save_path, "rb") as f:
            st.download_button(
                label="Baixar PDF",
                data=f,
                file_name="Relatorio_Hosp_Est.pdf",
